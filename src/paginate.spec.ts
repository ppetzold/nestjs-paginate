...
describe('paginate', () => {
    ...
    describe('distance columns ($dist)', () => {
        // Origin: Brussels. Fixtures are ordered by increasing distance from it so that a
        // nearest-first sort has a single unambiguous answer regardless of the distance strategy.
